...
public class ShopView extends JPanel {
	...
	void init() {
		...
		basketScrollPane.setBounds(420, 10, 370, 360);
		moveToBasketButton.setBounds(210, 420, 200, 50);
		removeButton.setBounds(590, 420, 200,50);
		sumLabel.setBounds(420, 380, 370, 30);
	...
	private void onBasketModelEvent(TableModelEvent tme) {
		...
		if (column == 0) {
			...
			System.out.println("Count of row() has changed!");
			recalcSum(model);
			...
			System.out.println("Row has been removed!");
			recalcSum(model);
		}
	}
	...
	private void recalcSum(TableModel model) {
		...
		sumLabel.setText("Summe:" + String.format("%.2f", sum) + " €");
	}
